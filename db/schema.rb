...
ActiveRecord::Schema.define(version: 2020_10_31_174861) do
  ...
  create_table "script_executor_exec_scripts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["script_id"], name: "index_script_executor_exec_scripts_on_script_id"
  end

  create_table "script_executor_scripts", force: :cascade do |t|
    t.string "script_name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "description_id"
    t.index ["description_id"], name: "index_script_executor_scripts_on_description_id"
  end
