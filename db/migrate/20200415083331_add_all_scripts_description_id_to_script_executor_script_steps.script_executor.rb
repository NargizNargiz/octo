class AddAllScriptsDescriptionIdToScriptExecutorScriptSteps < ActiveRecord::Migration[4.2]
  def change
  	  	add_column :script_executor_script_steps, :all_scripts_description_id, :integer
  end
  # def up
